...
def predict_labels(training_set, training_labels, test_set, test_labels, similarity_function, evaluation_function, K):
    ...
    def predict_single_label(test_point):
            ...
            for index, cur_entry in enumerate(training_set):
                similarity_score = similarity_function(test_point, cur_entry)
